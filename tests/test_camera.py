...
def test_camera_point_translation():
    cam = Camera(viewport=(0, 0, 800, 600), pixel_ratio=80)
    assert cam.position == Vector(0, 0)
    assert cam.translate_to_game_space(Vector(400, 300)) == Vector(0, 0)
    assert cam.translate_to_game_space(Vector(560, 220)) == Vector(2, -1)
    cam.position = Vector(5, 5)
    assert cam.translate_to_game_space(Vector(400, 300)) == Vector(5, 5)
    assert cam.translate_to_game_space(Vector(560, 220)) == Vector(7, 4)
